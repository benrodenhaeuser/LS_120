module TTT
  ...
  class Computer < Player
    ...
    def choose_square
      case skill_level
      when 1 then add_random_move_to_board(color)
      when 2 then add_reasonably_smart_move_to_board(color)
      when 3 then add_optimal_move_to_board(color)
      end
    end
    ...
    def add_random_move_to_board(color)
      board.add_move(available_squares.sample, color)
    end

    def add_reasonably_smart_move_to_board(color)
      board.add_move(reasonable_square(color), color)
    end

    def add_optimal_move_to_board(color)
      board.add_move(nega_max(color, :top), color)
    end
