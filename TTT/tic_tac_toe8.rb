module TTT
  ...
  module MessageToUser
    ...
    def self.want_to_customize
      prompt("Would you like to customize the settings? (y/n)")
    end

    def self.acknowledge_settings
      prompt("The settings for this match are as follows: ...") # todo
    end
    ...
    def self.acknowledge_skill_level(number)
  ...
  module GetUserInput
    ...
    def self.choose_skill_level(levels)
      ...
      MessageToUser.acknowledge_skill_level(level_chosen)
      GetUserInput.press_enter
      level_chosen
    end
  ...
  class Game
    ...
    def configure
      ...
      MessageToUser.acknowledge_settings
      GetUserInput.press_enter
    end
